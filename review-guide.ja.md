...
拉取请求列表可以在 [项目页面] (https://github.com/doc-l10n-kit/ja-quarkusio) 的“拉取请求”选项卡上找到。
...
请在按下该按钮打开的输入表单中写下评论。
有两个提交按钮，“添加单条评论”和“开始评论”，但“添加单条评论”按钮被添加为单条评论。
...
! [更改建议意见表] (internal/docs/images/Suggestion-comment-form.png)
